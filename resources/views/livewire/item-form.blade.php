<div class="mb-4">
  ...
  <div class="flex gap-2">
    ...
    <select wire:model="categoryId"
        class="text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-2 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white">

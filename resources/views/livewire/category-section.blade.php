  ...
  <div data-content>
    ...
    <form wire:submit="addItem" class="flex gap-2">
      <input type="text" wire:model="newItemText"
             oninput="filterCategoryItems(this, 'cat-{{ $category->id }}')"
             id="input-add-item-{{ $category->id }}" placeholder="Agregar item..."
    ...
    {{-- Items --}}
    <div class="divide-y dark:divide-gray-700" data-items-container="cat-{{ $category->id }}">

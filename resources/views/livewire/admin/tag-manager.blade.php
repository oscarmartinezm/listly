<div class="bg-white rounded-xl shadow-sm mb-4">
  <div class="px-4 py-3 border-b">
    <h3 class="text-sm font-semibold text-gray-600">Tags <span class="font-normal text-gray-400">— {{ $listName }}</span></h3>
  </div>
  ...
  <div class="divide-y">
    @forelse($tags as $tag)
      <div class="px-4 py-2.5 flex items-center justify-between">
        ...
        @else
          ...
          <div class="flex items-center gap-2">
            <button wire:click="startEdit({{ $tag->id }})" class="text-xs text-gray-400 hover:text-gray-600">Editar</button>
    ...
    @empty
      <div class="px-4 py-3 text-sm text-gray-400 text-center">Sin tags</div>
    @endforelse
  </div>
</div>

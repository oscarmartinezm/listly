    ...
    <form wire:submit="import" class="space-y-3">
      ...
      <div class="flex gap-2 items-end">
        <div class="flex-1">
          ...
          <select wire:model="categoryId" class="w-full text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">

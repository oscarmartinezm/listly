...
<body class="min-h-dvh bg-gray-100 dark:bg-gray-900">
  ...
  <div class="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
    ...
    <a href="{{ route('home') }}"
       class="text-sm px-3 py-2 rounded-lg {{ request()->routeIs('home') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
      Inicio
    </a>
    <a href="{{ route('admin') }}"
       class="text-sm px-3 py-2 rounded-lg {{ request()->routeIs('admin') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
      Admin
    </a>
